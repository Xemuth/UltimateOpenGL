...
Shader& Shader::SetBool(Upp::String name, bool value) const{
    glUniform1i(glGetUniformLocation(ID, name.ToStd().c_str()), (int)value);
    return *this;
}
Shader& Shader::SetInt(Upp::String name, int value) const{
    glUniform1i(glGetUniformLocation(ID, name.ToStd().c_str()), value);
    return *this;
}
Shader& Shader::SetFloat(Upp::String name, float value) const{
    glUniform1f(glGetUniformLocation(ID, name.ToStd().c_str()), value);
    return *this;
}
Shader& Shader::SetVec2(Upp::String name, const glm::vec2 &value) const{
    glUniform2fv(glGetUniformLocation(ID, name.ToStd().c_str()), 1, &value[0]);
    return *this;
}
Shader& Shader::SetVec2(Upp::String name, float x, float y) const{
    glUniform2f(glGetUniformLocation(ID, name.ToStd().c_str()), x, y);
    return *this;
}
Shader& Shader::SetVec3(Upp::String name, const glm::vec3 &value) const{
    glUniform3fv(glGetUniformLocation(ID, name.ToStd().c_str()), 1, &value[0]);
    return *this;
}
Shader& Shader::SetVec3(Upp::String name, float x, float y, float z) const{
    glUniform3f(glGetUniformLocation(ID, name.ToStd().c_str()), x, y, z);
    return *this;
}
Shader& Shader::SetVec4(Upp::String name, const glm::vec4 &value) const{
...
Shader& Shader::SetMat2(Upp::String name, const glm::mat2 &mat) const{
    glUniformMatrix2fv(glGetUniformLocation(ID, name.ToStd().c_str()), 1, GL_FALSE, &mat[0][0]);
    return *this;
}
Shader& Shader::SetMat3(Upp::String name, const glm::mat3 &mat) const{
    glUniformMatrix3fv(glGetUniformLocation(ID, name.ToStd().c_str()), 1, GL_FALSE, &mat[0][0]);
    return *this;
}
Shader& Shader::SetMat4(Upp::String name, const glm::mat4 &mat) const{
