...
class GameObject: public Upp::Moveable<GameObject>{
	protected:
		...
		void ThisObjectCarryLight();
		Upp::Array<Light*> GetAllLightsOftheObject(); //used to remove light from scene
	public:
		//*******GameObject**************************************
		GameObject();
		...
		//******************Light part******************************
		const Upp::Vector<Upp::String>& GetAllDirLightsKeys();
		DirLight& GetDirLight(const Upp::String& _name);
		DirLight& AddDirLight(const Upp::String& _name);
		
		const Upp::Vector<Upp::String>& GetAllSpotLightsKeys();
		SpotLight& GetSpotLight(const Upp::String& _name);
		SpotLight& AddSpotLight(const Upp::String& _name);
		
		const Upp::Vector<Upp::String>& GetAllPointLightsKeys();
		PointLight& GetPointLight(const Upp::String& _name);
